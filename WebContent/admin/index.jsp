    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="../index.jsp" class="logo">
                ...
                <span class="logo-mini"><b>笃行</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>笃行-日志后台</b></span>
            </a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="../LoginOutServlet" class="btn btn-default btn-flat">注销</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="sidebar-menu"  >
				    ...
				    <li class="treeview">
				        ...
				        <ul class="treeview-menu">
				            <li id="admin-login">
				                <a href="UserServlet" target="iframe">
					...
					<li class="treeview">
				        ...
				        <ul class="treeview-menu">
				            ...
				            <li id="admin-login">
				                <a href="articleManage.jsp" target="iframe">
				                    <i class="fa fa-circle-o"></i>日志管理
				                </a>
				            </li>
							<li id="admin-login">
				                <a href="tagManage.jsp" target="iframe">
				                    <i class="fa fa-circle-o"></i>标签管理
				                </a>
				            </li>							
							<li id="admin-login">
				                <a href="commentManage.jsp" target="iframe">
					...
					<li class="treeview">
				        ...
				        <ul class="treeview-menu">
							<li id="admin-login">
				                <a href="linkManage.jsp" target="iframe">
				                    <i class="fa fa-circle-o"></i>友链详情
				                </a>
				            </li>
				        </ul>                        
				    </li>
